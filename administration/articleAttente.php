  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Publications en attente</li>
      </ol>
      <!-- Icon Cards-->
...
<div class="container-fluide">
        ...
        <?php
            $d =  date('Y-m-d');
            $articles = $DB->query("SELECT * FROM articles WHERE statutArticle = 'en attente' ");
	...
	<div class="row">
          <div class="col-12 col-md-8">
              <article>
                      ...
                      <div class="col-12">
                          <span class="label label-default pull-right" class="label"><?= $article->statutArticle ?></span>
