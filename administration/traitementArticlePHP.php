...
if(isset($titreArticle) && isset($corpsArticle) && isset($idArticle)){
    $update = $DB->query('UPDATE articles SET titreArticle = :titre, corpsArticle = :corps, statutArticle = :statut WHERE idArticle = :id',[
        ...
        'statut' => "validé"
            ...
            $articles = $DB->query("SELECT * FROM articles WHERE idArticle = $idArticle");
...
<div class="row">
          <div class="col-12">
              ...
              <h4><input name="titreArticle" type="text" style="width:50%;" value="<?= $article->titreArticle ?>"></h4>
                      ...
                      <div class="col-12">
                       ...
                       <textarea name="corpsArticle" id="" cols="60" rows="12"><?= $article->corpsArticle ?></textarea>
                      </div>
                      <div class="col-12">
                          <input type="submit" class="btn btn-success" value="Valider">
                </form> 
                          <a href="deletArticle.php?idArticle=<?= $article->idArticle ?>"> <button class="btn btn-danger"> Suprimmer</button></a>
                          <br>
                          <br>
                      </div>
                      <div class="col-12">
                        <form method="post" action="retourArticle.php">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="hidden" value="<?= $article->idArticle ?>" name="id">
