...
<?php 
              $url = "http://webngraf.com/api/news/read.php";
...
<div class="row">
          <div class="col-12 col-md-8">
              <article>
                      <div class="col-12">
                          <figure>
                              <img src="http://webngraf.com/api/images-articles/<?= $data[$i]->imgArticle ?>">
                          </figure>
                      </div>
                      <div class="col-12">
                          <span class="label label-success pull-right" class="label"><?= $data[$i]->statutArticle ?></span>
                          <h4><?= $data[$i]->titreArticle ?></h4>
                          <p><?= $data[$i]->corpsArticle ?></p>
                          <p><?= $data[$i]->datePublication ?></p>
                          <section>
                              <i class="glyphicon glyphicon-folder-open"></i>
                              <i class="glyphicon glyphicon-user"></i>
                              <i class="glyphicon glyphicon-calendar"></i>
                              <i class="glyphicon glyphicon-eye-open"></i>
                              <a href="traitementArticle.php?idArticle=<?= $data[$i]->idArticle ?>"><button class="btn btn-primary btn-sm pull-right">Traiter l'article ... </button></a>
                          </section>
                      </div>
              </article>
          </div>
